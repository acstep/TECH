...
const OUT_FILE = '/home/matt/.openclaw/workspace/TECH/news_raw_0805.json';
const CONTENT_FILE = '/home/matt/.openclaw/workspace/TECH/news_content_0805.json';
...
async function main() {
  console.log('Starting TechCrunch AI news fetch for 2026-08-05...');
  ...
  const toFetch = filtered.filter(a => !fetchedLinks.has(a.link)).slice(0, 35);
